...
DP_Country_ISO3 <- 'IND'
# Impacted States
VT_States_Core <- c("Uttrakhand", "Uttar Pradesh", "Bihar", 
...
# Rivers crossing the country
SP_Rivers_Country <- intersect(SP_Rivers, SP_Country)
# SP_Rivers_Country@data$name.1
# Rivers flooded
SP_Rivers_Flooded <- SP_Rivers_Country[SP_Rivers_Country$name.1 %in% c("Ganges"),]
